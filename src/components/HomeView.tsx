    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-between p-6 pt-[env(safe-area-inset-top,1.5rem)] pb-[env(safe-area-inset-bottom,1.5rem)] select-none overflow-y-auto">
      ...
      <div className="flex flex-col items-center justify-center my-auto py-8 space-y-8 text-center">
        <button
          ...
          className="w-64 h-64 rounded-full bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-500 shadow-[0_0_60px_rgba(79,70,229,0.3)] flex flex-col items-center justify-center transition-transform active:scale-95 p-4 touch-manipulation cursor-pointer border-4 border-indigo-500/30 shrink-0"
        >
